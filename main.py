...
# The name of this app is Victoria's Badazz
#Chatgpt made the UI code here with PyQt6

#This code uses an outdated pillow version 9.4.0
#To make it work on Mac and Windows, i used python virtual env
#No need for virtual env on Windows or Mac, i used python3.11
#Pillow 10 deprecated some functions in version 9.4 that i use here
...
if __name__ == '__main__':
    print("Welcome to Victoria's Badazz")
